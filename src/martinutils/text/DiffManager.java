...
public class DiffManager {
  ...
  // Defaults.
  // Set these on your DiffManager instance to override the defaults.
    ...
    for (Diff aDiff : diffs) {
      ...
      case INSERT:
        //html.append("<ins style=\"background:#e6ffe6;\">").append(text).append("</ins>");
    	  html.append("<ins style=\"color:#0000FF;text-decoration:underline;\">").append(text).append("</ins>");
        break;
      case DELETE:
        //html.append("<del style=\"background:#ffe6e6;\">").append(text).append("</del>");
    	html.append("<del style=\"color:red;text-decoration: line-through;\">").append(text).append("</del>");
        break;
      case EQUAL:
